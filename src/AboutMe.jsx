    ...
    return (
        <section className="about-me">
            <div className="container">
                <div className="box-1">
                    <h1>About Me</h1>
                    <p>Hello! I am Anthony Micco. I was inspired to pursue a career in the
                ...
                <div className="box-2">
                    ...
                    <ul className="tech">
                        <li className="lang">Java</li>
                        <li className="lang">C++</li>
                        <li className="lang">Python</li>
                        <li className="lang">SQL</li>
                        <li className="lang">CSS</li>
                        <li className="lang">HTML</li>
                        <li className="lang">Javascript</li>
                        <li className="lang">Typescript</li>
